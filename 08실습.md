...
...
# 아래는 쉘
obj = Director.objects.get(name="봉준호")
obj.print()
```
...
...
# 아래는 쉘
obj = Genre.objects.get(title="드라마")
obj.print()
```
...
for movie in movies:
     temp = Movie()
     temp.director = Director.objects.get(name=movie[0])
     temp.genre = Genre.objects.get(title=movie[1])
     temp.title = movie[2]
     temp.opening_date = movie[3]
     temp.running_time = movie[4]
     temp.screening = movie[5]
     temp.save()
```
...
```
Director object (1) Genre object (2) 기생충 2019-05-30 False
Director object (1) Genre object (2) 괴물 2006-07-27 False
Director object (1) Genre object (6) 설국열차 2013-10-30 False
Director object (2) Genre object (3) 한산 2022-07-27 True
Director object (3) Genre object (6) 외계+인 2022-07-20 False
Director object (4) Genre object (8) 헌트 2022-08-10 True
Director object (5) Genre object (1) 복수혈전 1992-10-10 False
Director object (6) Genre object (9) 비상선언 2022-08-03 True
Director object (7) Genre object (1) 탑건 : 매버릭 2022-06-22 True
```
...
```python
for movie in Movie.objects.all().order_by('-opening_date'):
     print(movie.director.name, movie.genre.title, movie.title, movie.opening_date, movie.running_time, movie.screening)
```
...
```python
for movie in Movie.objects.filter(director=Director.objects.get(name="봉준호")).order_by( 
"opening_date"):
     print(movie.director.name, movie.genre.title, movie.title, movie.opening_date, movie.running_time, movie.screening)
```
...
```python
movie = Movie.objects.filter(director=Director.objects.get(name="봉준호")).order_by("open 
ing_date")[1]
print(movie.director.name, movie.genre.title, movie.title, movie.opening_date, movie.runn 
ing_time, movie.screening)
```
...
```python
for movie in Movie.objects.filter(running_time__gt=119).order_by("running_time"):
     print(movie.director.name, movie.genre.title, movie.title, movie.opening_date, movie.running_time, movie.screening)
```
...
```python
for movie in Movie.objects.filter(running_time__gte=119).order_by("running_time"):
     print(movie.director.name, movie.genre.title, movie.title, movie.opening_date, movie.running_time, movie.screening)
```
...
```python
for movie in Movie.objects.filter(opening_date__gt="2022-01-01").order_by("opening_date"):   
     print(movie.director.name, movie.genre.title, movie.title, movie.opening_date, movie.running_time, movie.screening)
```
...
```python
for movie in Movie.objects.filter(director=Director.objects.get(name="봉준호"), genre=Genre.objects.get(title="드라마")).order_by("opening_date"):
     print(movie.director.name, movie.genre.title, movie.title, movie.opening_date, movie.running_time, movie.screening)
```
...
```python
for movie in Movie.objects.exclude(director=Director.objects.get(name="봉준호")).order_by("opening_date"):
     print(movie.director.name, movie.genre.title, movie.title, movie.opening_date, movie.running_time, movie.screening)
```
